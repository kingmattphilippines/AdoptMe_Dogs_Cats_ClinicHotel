...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h2><b><i class="fa fa-paw"></i> Add Pets</b></h2>
  </header>

  <div class="w3-container">
    <button class="w3-button w3-green" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i>&nbsp; Register</button>
  </div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
            ...
            <?php } else { ?>
                <img src="upload/<?=$row['PET_DISPLAY'];?>" class="card-img-top" width="75" height="75" alt="...">
            <?php } ?>
        </td>
        ...
        <td>
          <div class="btn-group">
              <a href="admin_view_pet.php?q=<?=$row['ID'];?>" class="w3-button w3-teal no-underline">View</a>
              <a href="admin_edit_pet.php?q=<?=$row['ID'];?>" class="w3-button w3-blue no-underline">Edit</a>
              <a href="admin_delete_pet.php?q=<?=$row['ID'];?>" class="w3-button w3-red no-underline">Delete</a>
          </div>
        </td>
      </tr>
      <?php } ?>
